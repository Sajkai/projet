 ...
 */
class getSecurity_AccessMapService extends App_KernelDeDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/renter'), [0 => 'ROLE_LOUEUR'], NULL);
