...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'name', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'cars', '' . "\0" . 'App\\Entity\\User' . "\0" . 'rentals'];
        }
    ...
    public function checkIfAdmin(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'checkIfAdmin', []);

        return parent::checkIfAdmin();
    }
     ...
     * {@inheritDoc}
     */
    public function addRent(\App\Entity\Rent $rent): \App\Entity\User
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRent', [$rent]);

        return parent::addRent($rent);
    }

    /**
     * {@inheritDoc}
     */
    public function removeRent(\App\Entity\Rent $rent): \App\Entity\User
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeRent', [$rent]);

        return parent::removeRent($rent);
    }
